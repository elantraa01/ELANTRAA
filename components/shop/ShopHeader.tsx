...
export default function ShopHeader({
  ...
  return (
    <div className="mb-8">
      {/* Breadcrumbs */}
      <nav className="flex items-center space-x-2 text-xs text-gray-500 font-light mb-4 uppercase tracking-widest">
        <Link href="/" className="hover:text-[#C9A648] transition-colors">
          Home
        </Link>
        <span>/</span>
        <span className="text-gray-900 font-medium">Shop Catalogue</span>
      </nav>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-gray-200 pb-6">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-gray-900 mt-1 tracking-tight">
            Haute Couture Shop
          </h1>
        </div>
      ...
      <div className="mt-6 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="lg:hidden flex items-center space-x-2 px-4 py-2.5 bg-white border border-gray-300 rounded text-xs font-medium uppercase tracking-wider text-gray-800 hover:border-[#C9A648] transition-colors shadow-sm"
        >
        ...
        <div className="flex items-center space-x-3 ml-auto">
          ...
          <select
            ...
            className="px-3 py-2 bg-white border border-gray-300 rounded text-xs text-gray-800 uppercase tracking-wider font-medium focus:outline-none focus:border-[#C9A648] cursor-pointer shadow-sm"
          >
